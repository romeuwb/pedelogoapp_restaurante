...
class AddProductScreen extends StatefulWidget {
  ...
  const AddProductScreen({super.key, required this.product, required this.translations});
            ...
            return categoryController.categoryList != null ? Column(children: [
              ...
              Expanded(child: SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        child: DropdownButton<int>(
                          ...
                          items: categoryController.categoryIds.map((int? value) {
                            return DropdownMenuItem<int>(
                              ...
                              child: Text(value != 0 ? categoryController.categoryList![(categoryController.categoryIds.indexOf(value)-1)].name! : 'Select'),
                            );
                          }).toList(),
                          onChanged: (int? value) {
                        ...
                        child: DropdownButton<int>(
                          ...
                          items: categoryController.subCategoryIds.map((int? value) {
                            return DropdownMenuItem<int>(
                              ...
                              child: Text(value != 0 ? categoryController.subCategoryList![(categoryController.subCategoryIds.indexOf(value)-1)].name! : 'Select'),
                            );
                          }).toList(),
                          onChanged: (int? value) {
                  ...
                  VariationViewWidget(restController: restController, product: widget.product),
