...
class CustomDropdownWidgetState<T> extends State<CustomDropdownWidget<T?>> with TickerProviderStateMixin {
      ...
      child: SizedBox(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(mainAxisAlignment: style.mainAxisAlignment ?? MainAxisAlignment.center, textDirection: widget.leadingIcon ? TextDirection.rtl : TextDirection.ltr,
                ...
                child: Material(
                  ...
                  child: SizeTransition(
                    ...
                    child: ConstrainedBox(
                      constraints: widget.dropdownStyle.constraints ?? BoxConstraints(maxHeight: MediaQuery.of(context).size.height - topOffset - 15),
                      child: ListView(
